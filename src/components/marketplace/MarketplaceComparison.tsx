              ...
              <div className="block sm:hidden">
                  ...
                  <div className="flex min-w-max">
                    ...
                    {Array(3 - items.length)
                      ...
                      .map((_, index) => (
                        <div
                          key={`empty-${index}`}
                          className="w-56 flex-shrink-0 border border-dashed border-gray-200 rounded-lg flex items-center justify-center mx-2"
                        >
                ...
                <div className="space-y-4 overflow-x-auto">
                  ...
                  <div className="pb-3 border-t border-gray-100 pt-3">
                    ...
                    <div className="flex min-w-max">
                      {items.map((item) => (
                        <div key={`${item.id}-details`} className="w-56 px-2">
                          <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700">
                            {(item.learningOutcomes || item.details || [])
                              .slice(0, 3)
              ...
              <div className="hidden sm:block">
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                  ...
                  {Array(3 - items.length)
                    ...
                    .map((_, index) => (
                      <div
                        key={`empty-${index}`}
                        className="col-span-1 border border-dashed border-gray-200 rounded-lg flex items-center justify-center"
                      >
                        <span className="text-gray-400 text-sm">
                          Add an item
                        </span>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-4 gap-4 py-3 border-t border-gray-100">
                    ...
                    {items.map((item) => (
                      <div key={`${item.id}-details`} className="col-span-1">
                        <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700">
                          {(item.learningOutcomes || item.details || []).map(
