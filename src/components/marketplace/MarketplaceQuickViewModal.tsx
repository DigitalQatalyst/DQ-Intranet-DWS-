        ...
        <div className="p-6">
            ...
            <ol className="inline-flex items-center space-x-1 md:space-x-2">
              ...
              <li>
                <div className="flex items-center">
                  ...
                  <Link
                    to={config.route}
                    className="ml-1 text-gray-600 hover:text-gray-900 md:ml-2 text-sm"
                  >
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-end">
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-blue-700 bg-blue-50 rounded-md border border-blue-200 hover:bg-blue-100 transition-colors"
            >
              View Full Details
            </button>
