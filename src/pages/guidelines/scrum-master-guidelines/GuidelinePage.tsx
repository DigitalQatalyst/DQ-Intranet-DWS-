          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-3 bg-white rounded-lg shadow-sm p-8 md:p-12">
              ...
              <GuidelineSection id="context" title="Context">
                <p>
                  DQ is deploying a unified Scrum Master Framework where every
                  associate functions as a Scrum Master at different levels,
                  depending on their position and responsibilities.
                </p>
                <p className="mt-4">
                  This adds to the previous structure of Sector Leads, Factory
                  Leads, Tower Leads, and traditional Scrum Masters with a
                  streamlined 5-type Scrum Master model that enhances agility,
                  alignment, accountability, and delivery momentum across all
                  units.
                </p>
              </GuidelineSection>
              ...
              <GuidelineSection id="purpose" title="Purpose">
                <p className="mb-4">
                  These guidelines define the structure, roles,
                  responsibilities, and governance expectations of the new Scrum
                  Master Framework.
                </p>
                <p>
                  They ensure standardization across all units, clarity of
                  responsibilities, and alignment to DQ&apos;s culture of
                ...
                <SummaryTable
                  ...
                  data={[
                    ...
                    },
                    {
                      ...
                      description:
                        "Position SMs may take on additional roles such as SM (Working Room).",
                    },
                    {
                      number: "04",
                      item: "Role SM",
                      description:
                        "A functional responsibility performed when required.",
                    },
                    {
                      number: "05",
                      item: "Role Examples",
              ...
              <GuidelineSection id="sm-coe" title="SM (CoE) - Position">
                <p className="mb-6">
                  The below table showcases the roles and responsibilities of
                  CoE Scrum Master
                </p>
                <SummaryTable
                  ...
                  data={[
                    ...
                    },
                    {
                      ...
                      item: "Core Function",
                      description:
                        "Governance, compliance, and ensuring adherence to DQ's L24 WR guidelines.",
                    },
                    {
                      number: "03",
                      item: "Deployment Involvement",
                      description:
                        "Highly involved in the initial deployment phase to onboard SM (Working Room) and activate each Working Room.",
                    },
                    {
                      number: "04",
                      item: "Stabilization Activities",
                      description:
                        "Conduct high-level scans across all Working Rooms once operational to ensure guidelines and the WR essence are intact.",
                    },
                    {
                      number: "05",
                      item: "Gap Resolution",
                      description:
                        "Identify gaps in WR performance/compliance and ensure corrective action via Unit/Factory/Tower SMs.",
                    },
                    {
                      number: "06",
                      item: "Standards Creation",
                      description:
                        "Develop and maintain Working Room guidelines (structure, flow, expectations).",
                    },
                    {
                      number: "07",
                      item: "Compliance Assurance",
                      description:
                        "Ensure guideline deployment and associate compliance across all units.",
                    },
                    {
                      number: "08",
                      item: "Continuous Optimization",
                      description:
                        "Optimize guidelines weekly based on observations, WR performance, and feedback.",
                    },
                  ]}
              ...
              <GuidelineSection id="sm-unit" title="SM (Unit) — Position">
                <p className="mb-6">
                  The below table showcases the roles and responsibilities of
                  Unit Scrum Masters: SM (Unit) represents the Scrum Masters
                  operating at the Sector, Factory, and Tower levels within each
                  unit.
                </p>
                <p className="mb-6">
                  They ensure that all parts of the unit function efficiently,
                  align with DQ&apos;s delivery structure, and maintain
                    ...
                    data={[
                      {
                        ...
                        item: "Scope",
                        description:
                          "DCO Operations, DBP Platform, DBP Delivery sectors.",
                      },
                      {
                        number: "02",
                      ...
                      },
                      {
                        ...
                        description:
                          "Ensure factories under the sector operate efficiently.",
                      },
                      {
                        number: "04",
                        item: "Unit Health",
                        description:
                          "Maintain visibility on sector-level performance and health.",
                      },
                      {
                        number: "05",
                        item: "Tracker Accuracy",
                        description:
                          "Ensure sector functional trackers are accurate and updated.",
                      },
                      {
                        number: "06",
                        item: "Gap Escalation",
                        description:
                          "Flag gaps to Factory SMs and drive resolution.",
                      },
                    ]}
                    ...
                    data={[
                      {
                        ...
                        item: "Scope",
                        description:
                          "Eg. Finance Factory, Deals Factory, Solution Factory, etc.",
                      },
                      {
                        number: "02",
                        item: "Working Room Support",
                      ...
                      },
                      {
                        ...
                        description:
                          "Ensure all towers under the factory operate effectively.",
                      },
                      {
                        number: "04",
                        item: "Planning",
                        description:
                          "Establish clear monthly, weekly, and daily plans for each tower.",
                      },
                      {
                        number: "05",
                        item: "Plan Monitoring",
                        description:
                          "Track progress against plans and maintain factory-level trackers.",
                      },
                      {
                        number: "06",
                        item: "ATP Review",
                        description:
                          "Review and validate ATPs of all factory associates.",
                      },
                      {
                        number: "07",
                        item: "Blocker Resolution",
                        description:
                          "Identify and proactively resolve blockers.",
                      },
                    ]}
                  ...
                  <SummaryTable
                    ...
                    data={[
                      ...
                      },
                      {
                        ...
                        description:
                          "Ensure all tasks under the towers have specifications and dates which the monthly/weekly targets will be derived from",
                      },
                      {
                        number: "04",
                      ...
                      },
                      {
                        ...
                        description:
                          "Resolve blockers or escalate when necessary.",
                      },
                      {
                        number: "06",
                        item: "Visibility",
                      ...
                      },
                      {
                        ...
                        item: "Blocker Resolution",
                        description:
                          "Communicate plan, progress, and blockers on team channels.",
                      },
                    ]}
              ...
              >
                <p className="mb-6">
                  The below table showcases the responsibilities of Working Room
                  Scrum Master:
                </p>
                <SummaryTable
                  title="SM (Working Room) - Role"
                  ...
                  data={[
                    ...
                    },
                    {
                      ...
                      description:
                        "Keep sessions focused on execution and measurable outcomes.",
                    },
                    {
                      number: "03",
                      item: "Monitor Engagement",
                      description:
                        "Track attendance, engagement, and task progress.",
                    },
                    {
                      number: "04",
                      item: "Blocker Resolution",
                      description:
                        "Pull in resources/support in real time to resolve blockers.",
                    },
                    {
                      number: "05",
                      item: "Routine Management",
                      description:
                        "Conduct CWS and Retros as per weekly agenda.",
                    },
                    {
                      number: "06",
                      item: "Culture Alignment",
                      description:
                        "Uphold DQ culture: accountability, collaboration, delivery momentum.",
                    },
                    {
                      number: "07",
                      item: "Reporting",
                      description:
                        "Post daily progress and unresolved items on relevant channels.",
                    },
                    {
                      number: "08",
                      item: "Context & Purpose Enablement",
                      description:
                        "Understanding of overall context & purpose of the task enabling associates to make meaningful, effective progress that delivers real value.",
                    },
                  ]}
              ...
              >
                <p className="mb-6">
                  The below table showcases the roles & responsibilities of
                  ...
                  data={[
                    {
                      ...
                      item: "Scope",
                      description:
                        "Dedicated Scrum Master for specific projects.",
                    },
                    {
                      number: "02",
                      item: "Multi-WR Participation",
                      description:
                        "Move across all Working Rooms where the project is active.",
                    },
                    {
                      number: "03",
                      item: "Delivery Flow",
                      description:
                        "Ensure project tasks progress smoothly across units.",
                    },
                    {
                      number: "04",
                      item: "Control Tower",
                      description:
                        "Conduct Control Tower for respective projects weekly",
                    },
                    {
                      number: "05",
                      item: "Visibility",
                      description:
                        "Maintain visibility and alignment across all WRs tied to the project.",
                    },
                    {
                      number: "06",
                      item: "Escalation",
                      description:
                        "Proactively escalate risks, delays, or blockers and ensure resolution takes place.",
                    },
                  ]}
              ...
              <GuidelineSection id="sm-atp" title="SM (ATP- Associate) - Role">
                <p className="mb-6">
                  The below table showcases the responsibilities of Associate
                  Scrum Master
                </p>
                <SummaryTable
                  ...
                  data={[
                    {
                      ...
                      description:
                        "Every associate act as their own Scrum Master.",
                    },
                    {
                      number: "02",
                      item: "Planner Discipline",
                      description:
                        "Ensure each ATP task is linked to Planner with clear context, purpose, approach, and CLIs.",
                    },
                    {
                      number: "03",
                      item: "Specification Clarity",
                      description:
                        "Define detailed specs and deadlines for each task.",
                    },
                    {
                      number: "04",
                      item: "Progress Visibility",
                      description:
                        "Maintain daily and weekly visibility on progress.",
                    },
                    {
                      number: "05",
                      item: "Self-Management",
                      description:
                        "Manage blockers independently and escalate when required.",
                    },
                    {
                      number: "06",
                      item: "Discipline",
