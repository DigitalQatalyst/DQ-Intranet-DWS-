...
import FinancialApplicationForm from "../forms/FinancialApplicationForm";
...
const coursePromoCards = [
  {
    ...
    description:
      "Explore financial opportunities and resources to grow your business.",
...
export const MarketplaceRouter: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={
          <MarketplaceDetailsPage
            marketplaceType="courses"
            bookmarkedItems={bookmarkedItems.courses}
            onToggleBookmark={(itemId) =>
              handleToggleBookmark("courses", itemId)
            }
          />
        }
      />
      ...
      />
      <Route
        path="/financial/:itemId"
        element={
          <MarketplaceDetailsPage
            marketplaceType="financial"
            bookmarkedItems={bookmarkedItems.financial}
            onToggleBookmark={(itemId) =>
              handleToggleBookmark("financial", itemId)
            }
          />
        }
      />
      <Route
        path="/financial/:itemId/apply"
        element={<FinancialApplicationForm />}
      />
      ...
      />
      <Route
        path="/non-financial/:itemId"
        element={
          <MarketplaceDetailsPage
            marketplaceType="non-financial"
            bookmarkedItems={bookmarkedItems["non-financial"]}
            onToggleBookmark={(itemId) =>
              handleToggleBookmark("non-financial", itemId)
            }
          />
        }
      />
      ...
      <Route
        ...
        element={
          <MarketplacePage
            ...
            title={knowledgeHubConfig.title}
            description={knowledgeHubConfig.description}
            promoCards={knowledgeHubPromoCards}
          />
        }
      />
      <Route
        path="/knowledge-hub/:itemId"
        element={
          <MarketplaceDetailsPage
            marketplaceType="knowledge-hub"
            bookmarkedItems={bookmarkedItems["knowledge-hub"]}
            onToggleBookmark={(itemId) =>
              handleToggleBookmark("knowledge-hub", itemId)
            }
          />
        }
      />
