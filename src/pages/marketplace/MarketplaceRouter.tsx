...
import NewsPage from './MediaCenterPage';
import NewsDetailPage from './MediaArticleDetailPage';
import PodcastSeriesPage from './PodcastSeriesPage';
import { DQWorkDirectoryPage } from '../WorkDirectoryPage';
...
export const MarketplaceRouter: React.FC = () => {
  ...
  return <Routes>
      ...
      <Route path="/media-center/:id" element={<JobDetailPage />} />
      <Route path="/media-center/:id/apply" element={<JobApplicationPage />} />
      <Route path="/opportunities" element={<Navigate to="/marketplace/media-center" replace />} />
