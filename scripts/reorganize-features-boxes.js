...
const boxedFeaturesSection = `## Features
...
async function reorganizeFeaturesBoxes() {
  console.log('Reorganizing Features section with boxed segments...\n');
  ...
  try {
    ...
    const newBody = beforeFeatures + boxedFeaturesSection + '\n\n' + afterFeatures;
    ...
    if (data && data.length > 0) {
      console.log('✓ Features section reorganized with boxed segments!');
    } else {
