...
async function updateRescueShiftGuidelines() {
  console.log('📝 Updating Rescue Shift Guidelines to be minimal and readable...\n');
  ...
  console.log('Updating with minimal, readable content...\n');
  ...
  if (updateError) {
    ...
    console.log('   - Minimal details for readability');
    console.log('   - Space between Description and Key Highlights');
    console.log('   - All titles bolded');
    console.log('   - Proper spacing throughout');
    console.log('   - Paraphrased to reduce overwhelm');
  }
}
