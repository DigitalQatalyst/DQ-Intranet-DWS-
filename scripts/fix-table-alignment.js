// scripts/fix-table-alignment.js
// Fix table alignment for perfect formatting
// Usage: node scripts/fix-table-alignment.js
...
// Updated body with perfectly aligned tables
...
async function main() {
  console.log('Fixing table alignment for perfect formatting...')
  ...
  console.log(`✓ All tables now have perfect left-aligned formatting`)
  console.log(`✓ Column alignment is consistent across all tables`)
  console.log(`✓ Guide available at: /marketplace/guides/scrum-master-framework`)
  console.log('\nDone! Table alignment is now perfect.')
}
