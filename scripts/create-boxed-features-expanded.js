...
const expandedBoxedFeatures = `## Features
...
async function createExpandedBoxedFeatures() {
  console.log('Creating expanded boxed Features section (no dropdowns)...\n');
  ...
  try {
    ...
    const newBody = beforeFeatures + expandedBoxedFeatures + '\n\n' + afterFeatures;
    ...
    if (data && data.length > 0) {
      console.log('✓ Features section updated with expanded boxed format (no dropdowns)!');
    } else {
