...
async function fixKeyHighlightsBold() {
  console.log('📝 Fixing Key Highlights - only title should be bolded...\n');
  ...
  console.log('Removing bold from Key Highlights items, keeping only title bolded...\n');
  ...
  if (updateError) {
    ...
    console.log('   - Only "Key Highlights" title is bolded');
    console.log('   - Items in the list are not bolded');
  }
}

fixKeyHighlightsBold().catch(console.error);
