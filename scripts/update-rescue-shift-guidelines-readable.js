...
async function updateRescueShiftGuidelines() {
  console.log('📝 Updating Rescue Shift Guidelines for better readability...\n');
  ...
  console.log('Updating with more readable, less wordy content...\n');
  ...
  if (updateError) {
    ...
    console.log('   - Simplified language');
    console.log('   - Better spacing and structure');
    console.log('   - Less wordy, more concise');
