...
async function recreate6xDFromScratch() {
  console.log('🔄 Deleting and recreating Agile 6xD (Products) from scratch...\n')
  
  // First, delete the existing guide
  ...
  console.log('✅ Deleted existing guide')
  
  // Create new guide based on GHC document
...
Drives execution speed and alignment through tools, systems, and strategies that compress time-to-value and scale measurable impact.
  ...
  console.log('✅ Guide recreated from scratch with proper structure!')
  console.log('✅ Overview tile + 6 independent product tiles!')
}

recreate6xDFromScratch().catch(console.error)
