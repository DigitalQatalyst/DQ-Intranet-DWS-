...
async function cleanFeaturesOnly() {
  console.log('🔄 Cleaning Feature Modules to show only the 10 features with short descriptions...\n')
  ...
  // Find the Feature Modules section and replace it with clean version
...
`
  ...
  newBody = newBody.replace(featureModulesRegex, cleanFeaturesSection)
  ...
  if (data) {
    console.log('✅ Successfully cleaned Feature Modules section!')
    console.log(`   Title: ${data.title}`)
    console.log(`   Slug: ${data.slug}`)
    console.log('\n✅ Feature Modules now shows only the 10 features with short descriptions - no detailed explanations.')
  }
}

cleanFeaturesOnly().catch(console.error)
