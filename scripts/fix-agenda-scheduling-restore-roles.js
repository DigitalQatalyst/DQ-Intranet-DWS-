...
// Clean, properly formatted content with separate sections and proper spacing
...
async function restoreRoles() {
  console.log('🔄 Restoring Roles & Responsibilities as separate section...\n');
  ...
  for (const guide of guides) {
    ...
    if (updateError) {
      ...
      console.log(`   - "Types of Scheduling Practices" as separate section (5 items)`);
      console.log(`   - "Roles & Responsibilities" as separate section (4 items)`);
