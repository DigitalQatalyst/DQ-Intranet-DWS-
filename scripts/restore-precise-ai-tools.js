...
async function restorePreciseAITools() {
  console.log('🔄 Restoring precise AI Tools section with single Cursor and Windsurf entries...\n')
  ...
  // Create precise AI Tools section with single entries
...
`
  ...
  if (aiToolsRegex.test(newBody)) {
    newBody = newBody.replace(aiToolsRegex, preciseAITools.trim() + '\n\n')
  } else {
  ...
  if (data) {
    console.log('✅ Successfully restored precise AI Tools section!')
    console.log(`   Title: ${data.title}`)
    console.log(`   Slug: ${data.slug}`)
    console.log('\n✅ AI Tools section now has single, precise entries for Cursor and Windsurf.')
  }
}

restorePreciseAITools().catch(console.error)
