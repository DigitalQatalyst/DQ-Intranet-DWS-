...
async function restructureVision() {
  console.log('🔄 Restructuring DQ Vision and Mission into tiles...\n')
  
  // Restructure into tiles similar to WFH format
...
- Building trust, momentum, and clarity — system by system, transaction by transaction, life by life
...
- We're building trust, momentum, and clarity
  ...
  console.log('✅ Content organized into 5 separate tiles!')
}

restructureVision().catch(console.error)
