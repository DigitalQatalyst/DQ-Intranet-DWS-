...
async function fixAllSectionsBoldSpacing() {
  console.log('📝 Fixing all sections - only titles bolded, proper spacing...\n');
  ...
  console.log('   - Only section titles are bolded');
  console.log('   - Content items are not bolded');
  console.log('   - Proper spacing between all sections\n');
  ...
  if (updateError) {
    ...
    console.log('   - All section titles are bolded (Key Highlights, Planning Process, etc.)');
    console.log('   - All content items are not bolded');
    console.log('   - Proper spacing between all sections');
  }
}

fixAllSectionsBoldSpacing().catch(console.error);
