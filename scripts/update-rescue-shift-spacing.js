...
async function updateRescueShiftGuidelines() {
  console.log('📝 Updating Rescue Shift Guidelines with bolded titles and proper spacing...\n');
  ...
  console.log('Updating with bolded section titles and proper spacing...\n');
  ...
  if (updateError) {
    ...
    console.log('   - Proper spacing above each section title');
