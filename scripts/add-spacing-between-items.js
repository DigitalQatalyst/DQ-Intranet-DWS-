...
async function addSpacingBetweenItems() {
  console.log('📝 Adding spacing between items within each section...\n');
  ...
  console.log('Adding blank lines between items in each section...\n');
  ...
  if (updateError) {
    ...
    console.log('   - Added spacing between each item in Key Highlights');
    console.log('   - Added spacing between each step in Planning Process');
    console.log('   - Added spacing between each item in During the Shift');
    console.log('   - Added spacing between each role in Roles & Responsibilities');
  }
}

addSpacingBetweenItems().catch(console.error);
