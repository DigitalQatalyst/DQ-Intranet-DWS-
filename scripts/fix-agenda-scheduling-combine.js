...
// Clean, properly formatted content with combined sections
...
async function combineSections() {
  console.log('🔄 Combining Agenda Design Guidelines sections...\n');
  ...
  for (const guide of guides) {
    ...
    if (updateError) {
      ...
      console.log(`   ✅ Successfully combined sections under "Agenda Design Guidelines"`);
      console.log(`   - All 13 guidelines now in one table`);
      console.log(`   - Removed separate Context, Purpose, Agenda Structure, and Related Materials subsections`);
    }
  }
...
combineSections().catch(console.error);
