...
async function fixEmptyBoxes() {
  console.log('🔄 Fixing empty boxes in DQ Vision and Mission...\n')
  
  // Clean content without any empty elements
...
- We're building trust, momentum, and clarity — system by system, transaction by transaction, life by life
  ...
  console.log(`✅ Successfully fixed: ${data.title} (${data.slug})`)
  console.log('✅ Removed empty boxes - content is clean!')
}

fixEmptyBoxes().catch(console.error)
