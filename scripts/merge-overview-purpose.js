// scripts/merge-overview-purpose.js
// Merge Purpose into Overview and make it shorter
// Usage: node scripts/merge-overview-purpose.js
...
// Updated body with merged Overview and Purpose
...
async function main() {
  console.log('Reading current content and merging Overview with Purpose...')
  
  const currentContent = await readCurrentContent()
  console.log('Current content read successfully.')
  console.log('\nMerging Purpose into Overview and making it shorter...')
  ...
  console.log(`✓ Merged Purpose into Overview section`)
  console.log(`✓ Made Overview shorter and more concise`)
  console.log(`✓ Removed separate Framework Purpose section`)
  console.log(`✓ Guide available at: /marketplace/guides/scrum-master-framework`)
  console.log('\nDone! Overview now includes purpose in a concise format.')
}
