...
const reorganizedFeaturesSection = `## Features
...
async function reorganizeFeatures() {
  console.log('Reorganizing Features section...\n');
  ...
  try {
    ...
    const newBody = beforeFeatures + reorganizedFeaturesSection + '\n\n' + afterFeatures;
    ...
    if (data && data.length > 0) {
      console.log('✓ Features section reorganized successfully!');
    } else {
