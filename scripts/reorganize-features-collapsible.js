...
const collapsibleFeaturesSection = `## Features
...
<details>
<summary><strong>DWS Landing</strong></summary>
...
<details>
<summary><strong>DQ Learning Center</strong></summary>
...
<details>
<summary><strong>DQ Services Center</strong></summary>
...
<details>
<summary><strong>DQ Work Center</strong></summary>
...
<details>
<summary><strong>DQ Work Directory</strong></summary>
...
<details>
<summary><strong>DQ Media Center</strong></summary>
...
<details>
<summary><strong>DQ Work Communities</strong></summary>
...
<details>
<summary><strong>DQ Knowledge Center</strong></summary>
...
<details>
<summary><strong>DWS Transact Apps</strong></summary>
...
<details>
<summary><strong>DQ Analytics Center</strong></summary>
...
async function reorganizeFeaturesCollapsible() {
  console.log('Reorganizing Features section with collapsible format...\n');

  try {
    const currentBody = await getCurrentBlueprint();
    ...
    const newBody = beforeFeatures + collapsibleFeaturesSection + '\n\n' + afterFeatures;
    ...
    if (data && data.length > 0) {
      console.log('✓ Features section reorganized with collapsible format!');
    } else {
      console.log('⚠ No blueprint found with slug "dws-blueprint"');
    }
  } catch (error) {
    console.error('✗ Error reorganizing Features section:', error.message);
  }

  console.log('\nDone!');
}

reorganizeFeaturesCollapsible();
